...
\begin{document}
	...
	\begin{story}{역린}{[종족: 델타 드래곤][광기]\hyperlink{celesteela}{ⓣ}}
	...
	\begin{story}{이그나이트}{[종족: 델타 드래곤]\hyperlink{celesteela}{ⓣ}}
		\pre{용족}
	...
	\begin{story}[delta-dragon:scale-of-dragon]{용의 비늘}{[종족: 델타 드래곤]\hyperlink{celesteela}{ⓣ}}
		\entry{원소 계열 공격과 마법에 의한 피해량이 5 이하라면 피해를 1만 받은 것으로 취급한다.}
		
		\cost{20}
	\end{story}
	
	\begin{story}{날렵한 신체}{[종족: 델타 드래곤][기피]\hyperlink{celesteela}{ⓣ}}
		\limitedtrauma{기피}{체력을 계산할 때, 신체당 제공되는 최대 체력의 양이 5에서 3로 감소한다.}
