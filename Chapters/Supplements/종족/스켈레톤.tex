...
\begin{document}
	...
	\begin{story}{분리 가능한 뼈}{[종족: 스켈레톤]}
		...
		\entry{뼈를 분리/조합할 수 있다. 특히, 다음이 가능하다:
			\begin{itemize}
				\item 다른 뼈를 구할 수 있다면, 자신의 몸에 연결해 자신의 것 처럼 사용할 수 있다. 특히, 이로 인해 추가 이야기나 스탯을 받게 될 수 있다.\footnote{예를 들어, 공룡 뼈를 연결했다면 근력을 추가로 받을 수 있고, 새의 날개뼈를 팔 대신 연결했다면 비행 능력을 가진 이야기 등을 얻게 될 수 있습니다.}
				\item 신체의 일부를 분리해도 자신의 의지대로 움직일 수 있다.
		\end{itemize}}
