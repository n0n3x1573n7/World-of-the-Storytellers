...
\begin{document}
	...
	\begin{story}[luck:pow-of-luck]{행운의 힘}{[도움: 행운]}
		모든 판정을 함에 있어, \storyref{luck:pow-of-luck}{행운의 힘}을 빌리기로 선택할 수 있다. 이 힘을 빌리기로 선택한 경우, 판정치에 4df를 굴려 합한 값이 최종 판정치가 된다.
	\end{story}
	
	\begin{story}{랜덤의 신}{[중립: 행운]}
		모든 판정을 함에 있어, \storyref{luck:pow-of-luck}{행운의 힘}을 반드시 빌려야 한다.
	\end{story}
	
	\begin{story}{랜덤의 신의 가호}{[중립: 행운]}
		\storyref{luck:pow-of-luck}{행운의 힘}을 빌렸다면, 판정치에 상관없이 4df의 값이 ++++이라면 대성공, -{}-{}-{}-이라면 대실패로 판정한다.
	\end{story}
