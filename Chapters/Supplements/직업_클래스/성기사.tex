...
\begin{document}
	...
	\begin{story}[paladin:holy-fury]{성스러운 빛을 믿고 분노를 제어하십시오}{[클래스:성기사]\hyperlink{celesteela}{ⓣ}}
		...
		\triggertrauma{기피}{성기사의 모든 행동은 선하며 세상에 질서를 가져와야 신념에 기반해야 한다. 이러한 신념에 어긋나는 행동을 한다.}{해당 행동에 대한 판정에 -2를 받는다.}
		
		\entry{성기사는 자신에게 특화된 무기를 정할 수 있다. 성기사는 미래지향적 무기를 제외하고 모든 무기에 특화 가능하다. 이 무기를 사용하는 데에 페널티를 받지 않는다.}
